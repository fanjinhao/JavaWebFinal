    ...
    <tr>
        ...
        <td valign="top" background="images/head_07.jpg" width="407" height="846">
            ...
            <table width="373" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#fece62">
                <tr>
                    <td valign="top" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;<%=articleForm.getContent() %>
                    </td>
                </tr>
            </table>
            <table width="373" border="0">
                <tr>
                    <td align="right"><%=articleForm.getPhTime()%>&nbsp;&nbsp;|&nbsp;&nbsp;阅读（<%=articleForm.getNumber()%>
                        ）&nbsp;&nbsp;|&nbsp;&nbsp;回复（<%=restoreDao.queryRestore(articleForm.getId()).size()%>）
                    </td>
                </tr>
            </table>
            <table width="373" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="36" align="right">
                        <div align="center"><a href="#" onclick="javascript:history.go(-1);"><img src="images/back.gif"></a>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table width="345" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#fece62">
                <tr>
                    ...
                    <td width="285" bgcolor="#FFFFFF"><%=restoreForm.getReTitle() %>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF">内容：</td>
                    <td bgcolor="#FFFFFF"><%=restoreForm.getReContent() %>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" bgcolor="#FFFFFF">
                        <div align="right">
                            回复人：<%=consumerDao.getConsumerForm(Integer.valueOf(restoreForm.getReAccount()))%>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <form name="form" method="post" action="ArticleServlet?method=7" onSubmit="return addRestore()">
                <table width="261" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                       bgcolor="#000000">
                    <tr>
                        <td width="88" bgcolor="#FFFFFF">回复主题：
                        </td>
                        <td width="183" bgcolor="#FFFFFF"><input name="reTitle" type="text" class="inputinput"
                                                                 size="26"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF"><input name="articleId" type="hidden" size="26"
                                                     value="<%=articleForm.getId()%>"><input name="accountId"
                                                                                             type="hidden" size="26"
                                                                                             value="<%=consumerForm.getId()%>"><%=consumerForm.getName()%>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                ...
                                &nbsp;&nbsp;
                                <a href="#" onClick="javascript:form.reset()"><img src="images/reset.gif"></a></div>
                        </td>
                    </tr>
                </table>
            </form>
