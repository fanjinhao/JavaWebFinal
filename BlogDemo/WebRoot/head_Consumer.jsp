...
<table width="366" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#F1BD36">
    <tr bgcolor="#FFFFFF">
        <td width="171" height="20">用户名：<%=consumerFormPT.getAccount()%>
        </td>
        <td width="195" height="20">姓名：<%=consumerFormPT.getName()%>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td height="20">性别：<%=consumerFormPT.getSex()%>
        </td>
        <td height="20">QQ号码：<%=consumerFormPT.getQQNumber()%>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td height="20">主页：<%=consumerFormPT.getMainPage()%>
        </td>
        <td height="20">兴趣：<%=consumerFormPT.getInterest()%>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td height="20">邮箱：<%=consumerFormPT.getEMail()%>
        </td>
