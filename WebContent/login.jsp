	...
	<form method="post" action="User_login.action" onsubmit="return checkForm()">
		<table>
			<tr class="name">
				...
				<td><input type="text" id="nickName" name="user.nickName" tabindex="1" autocomplete="off" /></td>
			</tr>
			<tr class="password">
				<td><label>密  码：</label></td>
				<td><input type="password" name="user.password" maxlength="16" id="password" tabindex="2"/></td>
			</tr>
			<tr class="code">
...
<div class="bottom">©2017 Fayne <a href="javascript:;" target="_blank">关于</a> <span>ahstu</span><img width="13" height="16" src="images/copy_rignt_24.png" /></div>
