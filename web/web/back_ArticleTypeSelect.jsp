                ...
                <tr>
                    <td valign="top" align="center">
                        ...
                        <table width="399" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <div align="right"><a href="back_ArticleTypeAdd.jsp">添加</a></div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="486" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td height="20">
                                    <div align="center"><%=articleTypeForm.getTypeName()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><%=articleTypeForm.getDescription()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><a href="javascript:deleteForm('<%=articleTypeForm.getId()%>')">删除</a>
                                    </div>
                                </td>
                            </tr>
                            <%} %>
