                    ...
                    <td valign="top" align="center">
                        ...
                        <%
                            if (pagination.getRecordSize() <= 0) {
                                out.println("<p align=center><img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;&nbsp;&nbsp;没有公告信息查询！</p>");
                            } else {


                                out.print("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;公告查询</p>");%>
                        <table width="486" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                               bgcolor="#FECE62">
                            <tr>
                                <td width="94" height="25">
                                    <div align="center">公告题目</div>
                                </td>
                                <td width="155">
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td height="25">
                                    <div align="center"><%=discussForm.getDiscussTitle()%>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td title="如果想察看详细内容，单击相应的修改链接">
                                    <div align="center"><%=discussForm.getDiscussTime()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><a href="back_DiscussUpdate.jsp?id=<%=discussForm.getId()%>"
                                                           title="可以查看相应的公告内容">修改</a>&nbsp;&nbsp;<a
                                            href="javascript:deleteForm('<%=discussForm.getId()%>')">删除</a></div>
                                </td>
                            </tr>
                            <%} %>
