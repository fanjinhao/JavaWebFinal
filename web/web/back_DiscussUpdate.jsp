            ...
            <table width="573" border="0" cellpadding="0" cellspacing="0" background="images/back_noword_05.jpg">
                <tr>
                    <td valign="top" align="center">
                        ...
                        <%out.println("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;公告添加</p>");%>
                        <form name="form" method="post" action="DiscussServlet?method=2&id=<%=form.getId()%>"
                              onSubmit="return addDiscuss()">

                            <table width="340" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                                   bgcolor="#FECE62">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                        <div align="center">
                                            <textarea name="discussContent" cols="28" rows="20"
                                                      class="inputinput"><%=form.getDiscussContent()%></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                        <div align="center">
                                            <input name="discussTime" type="text" class="inputinput"
                                                   value="<%=form.getDiscussTime()%>" size="30" readonly="readonly"
