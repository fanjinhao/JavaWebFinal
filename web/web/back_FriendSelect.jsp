                    ...
                    <td valign="top">
                        ...
                        <table width="524" border="1" align="center" cellpadding="1" cellspacing="1"
                            ...
                            <tr align="center" bgcolor="#FFFFFF">
                                <td height="25"><%=friendForm.getName()%>
                                </td>
                                <td><%=friendForm.getQQNumber()%>
                                </td>
                                <td><%=friendForm.getDescription()%>
                                </td>
                                <td><a href="FriendServlet?method=2&id=<%=friendForm.getId()%>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="javascript:deleteForm('<%=friendForm.getId()%>')">删除</a></td>
                            </tr>
                            <%} %>
                        </table>
                        <!-- 显示分页导航栏 -->
