            ...
            <table width="573" border="0" cellpadding="0" cellspacing="0" background="images/back_noword_05.jpg">
                <tr>
                    <td valign="top" align="center">
                        ...
                        <form name="form" method="post" action="FriendServlet?method=3&id=<%=form.getId()%>"
                              onSubmit="return friendAdd()">
                            ...
                            <table width="340" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                        <div align="center">
                                            <textarea name="description" cols="28" rows="20"
                                                      class="inputinput"><%=form.getDescription()%></textarea>
                                        </div>
                                    </td>
                                </tr>
                            </table>
