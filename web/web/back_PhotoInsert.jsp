            ...
            <table width="573" border="0" cellpadding="0" cellspacing="0" background="images/back_noword_05.jpg">
                <tr>
                    <td valign="top" align="center">
                        ...
                        <form action="PhotoSerlvet?method=0" method="post" name="form" onSubmit="return addPhoto()"
                            ...
                            <table width="340" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                        <div align="left">
                                            <input name="phtoTime" type="text" class="inputinput"
                            ...
                            <table width="494" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="494">
                                        <br>
                                        <div align="center" class="style1">注意：图片的格式只能为：“JPG”,“jpg”,“gif”,“bmp”,“BMP”格式
                                        </div>
                                    </td>
                                </tr>
                            </table>
