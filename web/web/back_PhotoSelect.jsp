            ...
            <table width="573" border="0" cellpadding="0" cellspacing="0" background="images/back_noword_05.jpg">
                <tr>
                    <td valign="top" align="center">
                        ...
                        <table width="455" border="1" align="center" cellpadding="1" cellspacing="1"
                                    ...
                                    <div align="center">
                                        <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20">
                                                    <div align="center"><a
                                                            href="PhotoSerlvet?method=1&id=<%=photoForm.getId()%>">删除</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
        ...
        <tr>
            <td height="29" align="center">
                <input name="Submit2" type="button" class="btn_grey" value="关闭"
                       onClick="javascript:User.style.display='none';">
