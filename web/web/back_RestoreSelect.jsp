                ...
                <tr>
                    <td valign="top" align="center">
                        ...
                        <table width="486" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td height="30">
                                    <div align="center"><%=restoreForm.getReTitle()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><%=restoreForm.getReContent()%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><%=consumerDao.getConsumerForm(Integer.valueOf(restoreForm.getReAccount()))%>
                                    </div>
                                </td>
                                <td>
                                    <div align="center"><a
                                            href="javascript:deleteForm('<%=restoreForm.getId()%>','<%=request.getParameter("id") %>')">删除</a>
                                    </div>
                                </td>
                            </tr>
                            <%} %>
