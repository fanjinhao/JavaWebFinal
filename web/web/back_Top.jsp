...
<table width="800" height="65" border="0" align="center" cellpadding="0" cellspacing="0"
       background="images/back_noword_01.jpg">
    <tr>
        <td width="501">&nbsp;</td>
        <td width="299"><p>&nbsp;</p>
            <p><a href="head_main.jsp" class="backTop">我的首页</a>&nbsp;<font color="#FFFFFF">|</font>&nbsp; <a
                    href="backMainPage.jsp" class="backTop">管理博客</a>&nbsp;<font color="#FFFFFF">|</font>&nbsp; <a
                    href="dealwith.jsp?sign=2"" class="backTop">安全退出</a></p></td>
    </tr>
</table>
