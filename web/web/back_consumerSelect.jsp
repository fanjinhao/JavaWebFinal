...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td valign="top" background="images/back1.gif">
                ...
                <tr>
                    <td valign="top">
                        ...
                        <table width="524" border="1" align="center" cellpadding="1" cellspacing="1"
                               bordercolor="#FFFFFF" bgcolor="#FDD05D">
                            ...
                            <tr align="center" bgcolor="#FFFFFF">
                                <td height="25"><%=consumerForm.getAccount()%>
                                </td>
                                <td><%=consumerForm.getName()%>
                                </td>
                                <td><%=consumerForm.getSex()%>
                                </td>
                                <td><%=consumerForm.getQQNumber()%>
                                </td>
                                <td><a href="ConsumerServlet?method=2&account=<%=consumerForm.getAccount()%>">查询</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="javascript:deleteForm('<%=consumerForm.getAccount()%>')">删除</a></td>
                            </tr>
                            <%} %>
                        </table>
                        <!-- 显示分页导航栏 -->
