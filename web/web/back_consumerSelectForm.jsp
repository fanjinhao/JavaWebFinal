                        ...
                        <table width="325" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"
                            ...
                            <tr>
                                ...
                                <td width="219" bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getAccount()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getPassword()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getName()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getSex()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getQQNumber()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getMainPage()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getInterest()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td bgcolor="#FFFFFF">
                                    <div align="center"><%=consumerForm.getEMail()%>
                                    </div>
                                </td>
                            </tr>
                        </table>
