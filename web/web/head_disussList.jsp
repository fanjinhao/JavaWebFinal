...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td height="846" valign="top" background="images/head_07.jpg" width="407">
            <%
                out.println("<br><p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;查询所有公告信息</p>");
            %>
            <table width="387" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="FECE62">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td>
                        <div align="center"><a href="head_disussForm.jsp?id=<%=discussForm.getId()%>">详细查询</a></div>
                    </td>
                </tr>
                <%} %>
            </table>
